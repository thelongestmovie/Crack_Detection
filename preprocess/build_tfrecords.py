...
_NUM_SHARDS = 10
#数据集路径
DATASET_DIR = '/home/yangyuhao/data/road/data/test_data/label_filter/data_50'
#标签和文件名字
# LABELS_FILENAME = '/home/yangyuhao/data/road/data/test_data/label_filter'
TFRECORD_DIR = '/home/yangyuhao/data/road/data/test_data/label_filter/tf_data_50'
...
#把数据转为TFRecord格式
def _convert_dataset(split_name,filenames,class_names_to_ids,tfrecord_dir):
                    ...
                    with tf.python_io.TFRecordWriter(output_filename) as tfrecord_writer:
                        ...
                        for i in range(start_ndx,end_ndx):
                            try:
                                ...
                                sys.stdout.flush()
                                #读取图片
                                img_raw = tf.gfile.FastGFile(filenames[i],'rb').read()
...
if __name__=='__main__':
   ...
   # print(training_filenames[0])
    ...
    #_convert_dataset('test',testing_filenames,class_names_to_ids,TFRECORD_DIR)
    #_convert_dataset('validation', training_filenames, class_names_to_ids, TFRECORD_DIR)

    #输出labels文件
    labels_to_class_names = dict(zip(range(len(class_names)),class_names))
    write_label_file(labels_to_class_names,TFRECORD_DIR)
